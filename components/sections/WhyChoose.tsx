  ...
  return (
    <section className="relative py-24 ai-bg overflow-hidden">
      <div className="max-w-6xl mx-auto text-center relative z-10">
        ...
        <h2 className="text-3xl md:text-5xl font-bold text-gradient animate-fade-in-up">
          Kenapa Pilih SerangDev?
        </h2>

        <p className="mt-6 text-gray-400 max-w-2xl mx-auto px-6 animate-fade-in-up delay-100">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 mt-16 px-6">
          {features.map((feature, index) => {
            ...
            return (
              <div
                key={index}
                className="glass p-8 rounded-[2rem] text-left flex flex-col items-start group 
