      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex flex-col md:flex-row justify-between items-end mb-16 gap-6">
          ...
          <div className="animate-fade-in-up delay-100">
            <a
              href="#contact"
              className="group flex items-center gap-2 text-white bg-white/5 border border-white/10 px-6 py-3 rounded-2xl hover:bg-white/10 transition-all duration-300"
            >
              Konsultasi
              <ArrowUpRight
                size={18}
              ...
              >
                ...
                <div className="absolute inset-0 p-8 flex flex-col justify-between z-10">
                  <div className="flex justify-between items-start">
                    <div className="w-12 h-12 rounded-2xl bg-white/10 backdrop-blur-md flex items-center justify-center border border-white/20 group-hover:scale-110 group-hover:bg-purple-500 transition-all duration-300">
                      <Icon className="text-white w-6 h-6" />
                    </div>

                    <div className="w-10 h-10 rounded-full bg-white text-black flex items-center justify-center opacity-0 group-hover:opacity-100 -translate-y-4 group-hover:translate-y-0 transition-all duration-300 shadow-xl">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-400 line-clamp-2 opacity-0 group-hover:opacity-100 transition-all duration-300 translate-y-4 group-hover:translate-y-0">
                      {project.desc}
                    </p>
                  </div>
                </div>
