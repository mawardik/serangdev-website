                  ...
                  <table width="600" cellpadding="0" cellspacing="0" style="background:#ffffff; border-radius:12px; overflow:hidden;">
                    <tr> 
                      <td style="background:#ffffff; padding:30px; text-align:center;"> 
                        <img src="https://serangdev.com/serangdev-Hcolor.png" width="240" alt="SerangDev" /> 
                      </td> 
                    </tr> 
                    <tr> 
                      <td style="padding:40px;"> 
                        ...
                        <div style="margin:30px 0; text-align:center;"> 
                          <a href="https://wa.me/6281234567890" style="background:#25D366; color:#ffffff; padding:12px 24px; border-radius:8px; text-decoration:none; font-weight:bold;"> Chat WhatsApp Sekarang </a> 
                        </div> 
                    ...
                    <tr> 
                      <td style="background:#111827; color:#9ca3af; padding:20px; text-align:center; font-size:12px;"> © ${new Date().getFullYear()} SerangDev<br/> Website Development Specialist<br/> https://serangdev.com 
                      </td> 
                    </tr> 
                  </table> 
                </td> 
